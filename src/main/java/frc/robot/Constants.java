...
public final class Constants {
  ...
  public static class VisionConstants {
    ...
    // SMALLER numbers = trust vision MORE. A single tag is jittery, so we distrust it;
    // multiple tags give a solid triangulated pose, so we trust it much more.
    ...
    // Ignore any estimate whose average tag distance is beyond this (meters) — too far to trust.
